...
BOT_TOKEN = getenv("BOT_TOKEN", "8073469304:AAFS0nwpbKhAfsPaS87v_9j5AHA_lVlIqmo")
...
LOG_GROUP = getenv("LOG_GROUP", "-1002636842089")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1002589507150"))
