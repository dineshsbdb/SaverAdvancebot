...
async def terms(client, message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("💬 Contact Now", url="https://t.me/ilaps")],
        ]
    )
...
async def plan(client, message):
    plan_text = (
        "💰 **Premium Price**: Starting from $3 or 300 INR accepted via **UPI** (terms and conditions apply).\n"
...
async def see_plan(client, callback_query):
    plan_text = (
        "💰 **Premium Price**: Starting from $3 or 300 INR accepted via **__UPI__** (terms and conditions apply).\n"
        "📥 **Download Limit**: Users can download up to 100,000 files in a single batch command.\n"
        "🛑 **Batch**: You will get two modes /bulk and /batch.\n"
        "   - Users are advised to wait for the process to automatically cancel before proceeding with any downloads or uploads.\n\n"
